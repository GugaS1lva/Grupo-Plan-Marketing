...
const Contact = () => {
    return (
        <div id="Contact" className="p-7 text-white">
            ...
            <form>
                ...
                <div className="flex flex-col my-[25px]">
                    ...
                    <textarea
                        className="bg-[#1E1E1E] px-2 py-1 border-2 border-[#363636] rounded-md"
                        name="msg"
                        id="msg"
                        cols={30}
                        rows={5}
            ...
            <section className="mt-[100px]">
                <div className="text-center">
                    ...
                    <p className="my-[20px]">Fique sempre por dentro de todas as novidades da Plan XP e de todas empresas do Grupo Plan Marketing.</p>
                ...
                <div className="mt-[80px] mb-[30px] text-center">
                ...
                <div className="mt-[50px] mb-[30px] text-center">
                ...
                <div className="flex flex-col items-center justify-center text-center mt-[80px] mb-[30px]">
                    <Image
                        src="/PlanXPLogo.webp"
                        width={100}
                        height={100}
